...
model = create_model()
log_dir = os.path.abspath("C:/Users/Jan/Dropbox/_Programmieren/Udemy Tensorflow Kurs/logs/dogscats/final_gap3")
...
# model.save_weights(filepath=file_dir+"/weights/gap_cnn.h5")

model.load_weights(filepath=file_dir+"/weights/gap_cnn.h5")
