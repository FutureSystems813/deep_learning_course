...
model.add(Conv2D(filters=32, kernel_size=3, padding='same', input_shape=(width, height, depth))) #28x28x32
model.add(Activation("relu"))#28x28x32
model.add(MaxPool2D())#14x14x32
