...
# Save Path
dir_path = os.path.abspath("C:/Users/jan/Dropbox/_Programmieren/Udemy Tensorflow Kurs/models/")
if not os.path.exists(dir_path):
    os.mkdir(dir_path)
mnist_model_path = os.path.join(dir_path, "mnist_model.h5")
# Log Dir
log_dir = os.path.abspath("C:/Users/jan/Dropbox/_Programmieren/Udemy Tensorflow Kurs/logs/")
if not os.path.exists(log_dir):
    os.mkdir(log_dir)
logdir = os.path.join(log_dir, "model1")
