...
class Agent:
            ...
            while True:
                ...
                if done:
                    ...
                    if total_reward > best_total_reward:
                        ...
                        self.model.save_model("C:/Users/Jan/Dropbox/_Programmieren/Udemy Tensorflow Kurs/models/dqn.h5")
    ...
    def play(self, num_episodes, render=True):
        self.model.load_model("C:/Users/Jan/Dropbox/_Programmieren/Udemy Tensorflow Kurs/models/dqn.h5")
        for episode in range(num_episodes):
            state = self.env.reset()
            state = np.reshape(state, (1, state.shape[0]))
            while True:
